\chapter{SpaCy and Flair: A Qualitative Exploration of Existing NER Models}
...
Table \ref{tab:detect_ents_de} shows the results of both models for the example texts. I would like to emphasize that due to the small size of the explored sample, these explorations are rather anecdotal and cannot be generalized without further quantitative evaluation on a larger sample. 
