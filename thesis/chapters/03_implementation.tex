...
Data annotation turned out to be among the most challenging subtasks to accomplish for this thesis. 
Existing annotation schemes for NER vary greatly in terms of entity types, detailedness and precision of the provided definitions, granularity, and the handling of social media-specific phenomena like user mentions, urls, or hashtags. 

For this thesis, a custom annotation schema had to developed. The schema which includes basic definitions, detailed instructions as well as several examples can be found in the appendix (see \ref{cha:annotation_guide}). 

For annotation, the tool Labelstudio\footnote{https://labelstud.io/} was used.
